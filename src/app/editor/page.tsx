  ...
  return (
    <div className="flex flex-col h-[calc(100vh-130px)] sm:h-[calc(100vh-80px)]">
      <div className="flex justify-between items-center mb-3">
        ...
        <button className="bg-emerald-600 hover:bg-emerald-500 text-white px-3 py-1.5 rounded-lg text-xs font-medium flex items-center gap-1 transition">
          <Save size={14} /> 保存
        </button>
      </div>
